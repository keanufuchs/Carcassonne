...
nachweislich **während des Projekts schärften** (z. B. Zoom/Pan und E2E-Tests wurden
erst in Meeting #1 ergänzt — siehe Feedback-Zyklen unten).
...
`Kategorie · Priorität · Status · Aufwand (h) · Dauer · Start-/Enddatum · Release-Tag ·
Blocked-by/Blocking`.
...
|---------|-------|---------------------------|
| **#1 — Kickoff** | 04.05.2026 | Vorstellung Konzept; **2 Erweiterungen bestätigt** (Netzwerk + KI); **Zoom/Pan (MH-08) und E2E-Automatisierung (QS-03) neu gefordert**; QS-Schwellen fixiert; Windows-Priorität. |
| **#2** | 11.05.2026 | GUI-Fortschritt abgenommen; Vertiefung KI & Netzwerk beschlossen; MH-06 priorisiert. |
| **#3** | 01.06.2026 | EW-01 als stabil bestätigt; EW-02-Demo; Feature-Freeze geplant; Risiken Netzwerk/Windows bewertet; Game-Code-Beitritt (US-M3) und KI-Fallback (US-A3) bestätigt. |
| **#4 — Pre-Release Demo** | ~10.06.2026 | Abnahme-Demo; **Freigabe der agilen Anforderungsdokumentation** als Pflichtenheft-Äquivalent. |
...
- **US-Q2 / QS-03** „automatisierte Vollpartien (E2E)" — bestätigt in Meeting #1.
...
- **Desktop-Pakete** via `electron-builder` (Windows `.exe` / macOS `.dmg`).
...
| Windows-Stabilität | mittel | Windows-Priorität; CI-Desktop-Build; Web-Fallback. |
